...
def process_single_icon(input_path, output_path, corner_radius=200):
    ...
    print(f"  Crop Box: L={new_left}, T={new_top}, R={new_right}, B={new_bottom} (Size={size}x{size})")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python3 process_all_icons.py <input_path> <output_path>")
        sys.exit(1)
    process_single_icon(sys.argv[1], sys.argv[2])
